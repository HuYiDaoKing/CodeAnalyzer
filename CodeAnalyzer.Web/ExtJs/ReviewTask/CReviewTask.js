        ...
        var oContextmenu = new Ext.menu.Menu({
            ...
            items: [{
                ...
                handler: function () {
                    ...
                    ReviewTask.winPendingStatus(strId, strPendingReason);
                }
            }, {
                text: '完成任务',
                iconCls: 'icon-tick',
                handler: function () {
                    ...
                    ReviewTask.winFinishedQuestionaire(strId, strOldQuestionaire, strIsBug);
                }
            }]
        });
        ...
        var tbar = new Ext.Toolbar({
            items: [{
                ...
                handler: function () {
                    ...
                    var strUrl = ReviewTask.FormatUrl('all');
                ...
                handler: function () {
                    var strUrl = ReviewTask.FormatUrl('undeal');
                    var oGrid = Ext.getCmp(ID_DY_GRID_PANEL);
                    oGrid.reload(strUrl);
                }
            }, {
                ...
                handler: function () {
                    //Ext.Msg.alert("提示", "建设中...");
                    var strUrl = ReviewTask.FormatUrl('finished');
                    var oGrid = Ext.getCmp(ID_DY_GRID_PANEL);
                    oGrid.reload(strUrl);
                }
            }, {
    ...
    */
    this.winFinishedQuestionaire = function (strId, strOldQuestionaire, oldIsBug) {
        ...
        function UpdateRocord(strQuestionaire) {
            ...
            //需要在data参数里，加一个traditional：true的参数，这样就能正常发送数组参数了。原因时从1.4以后，jQuery改变了参数的序列化方法。
            $.ajax({
                //url: '/ReviewTask/UpdateQuestionaire',
                url: '/ReviewTask/FinishedStatus',
...
* CReviewTask. 单例对象
*/
var ReviewTask = new Lucky.CReviewTask();